...
package com.example.imac.animationsdemo;
...
public class ZoomActivity extends FragmentActivity {
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        thumbView.getGlobalVisibleRect(startBounds); //所点击按钮的位置
        ...
        if ((float) finalBounds.width() / finalBounds.height()
            ...
            float startHeight = startScale * finalBounds.height(); //获取到缩放之后的高度
            float deltaHeight = (startHeight - startBounds.height()) / 2; //获取到 缩放之后跟这个之后的差距 除以2   就是剧中的距离
            startBounds.top -= deltaHeight; //让比例缩放居中
            startBounds.bottom += deltaHeight; //底部加上 剧中的高度
        }
        ...
        Log.e("=====", startBounds.left + "  " + startBounds.top + "    " + thumbView.getLeft() + "    " + thumbView.getTop());
